...
4. **Assess severity:**
   - **CRITICAL**: User-facing breaking change, production outage risk
   - **HIGH**: Internal service breakage, degraded performance
   - **MEDIUM**: Potential edge case failures
   - **LOW**: Minor improvements needed
5. **Recommend tests** specific to each finding
